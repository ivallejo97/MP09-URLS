...
public class ClientTcpAdivina_Obj2 extends Thread {
    ...
    private ClientTcpAdivina_Obj2(String hostname, int port) {
        try {
    ...
    private void close(Socket socket){
        ...
        try {
            ...
            Logger.getLogger(ClientTcpAdivina_Obj2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        ClientTcpAdivina_Obj2 clientTcp = new ClientTcpAdivina_Obj2(ipSrv,5558);
